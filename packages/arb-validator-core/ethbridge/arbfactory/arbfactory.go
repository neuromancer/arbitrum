...
var ArbFactoryFuncSigs = map[string]string{
	...
	"79ca63d1": "createRollup(bytes32,uint128,uint128,uint64,uint64,uint128,address,address)",
...
var ArbFactoryBin = ""
...
// CreateRollup is a paid mutator transaction binding the contract method 0x79ca63d1.
//
// Solidity: function createRollup(bytes32 _vmState, uint128 _gracePeriodTicks, uint128 _arbGasSpeedLimitPerTick, uint64 _maxExecutionSteps, uint64 _maxTimeBoundsWidth, uint128 _stakeRequirement, address _stakeToken, address _owner) returns()
func (_ArbFactory *ArbFactoryTransactor) CreateRollup(opts *bind.TransactOpts, _vmState [32]byte, _gracePeriodTicks *big.Int, _arbGasSpeedLimitPerTick *big.Int, _maxExecutionSteps uint64, _maxTimeBoundsWidth uint64, _stakeRequirement *big.Int, _stakeToken common.Address, _owner common.Address) (*types.Transaction, error) {
	return _ArbFactory.contract.Transact(opts, "createRollup", _vmState, _gracePeriodTicks, _arbGasSpeedLimitPerTick, _maxExecutionSteps, _maxTimeBoundsWidth, _stakeRequirement, _stakeToken, _owner)
}

// CreateRollup is a paid mutator transaction binding the contract method 0x79ca63d1.
//
// Solidity: function createRollup(bytes32 _vmState, uint128 _gracePeriodTicks, uint128 _arbGasSpeedLimitPerTick, uint64 _maxExecutionSteps, uint64 _maxTimeBoundsWidth, uint128 _stakeRequirement, address _stakeToken, address _owner) returns()
func (_ArbFactory *ArbFactorySession) CreateRollup(_vmState [32]byte, _gracePeriodTicks *big.Int, _arbGasSpeedLimitPerTick *big.Int, _maxExecutionSteps uint64, _maxTimeBoundsWidth uint64, _stakeRequirement *big.Int, _stakeToken common.Address, _owner common.Address) (*types.Transaction, error) {
	return _ArbFactory.Contract.CreateRollup(&_ArbFactory.TransactOpts, _vmState, _gracePeriodTicks, _arbGasSpeedLimitPerTick, _maxExecutionSteps, _maxTimeBoundsWidth, _stakeRequirement, _stakeToken, _owner)
}

// CreateRollup is a paid mutator transaction binding the contract method 0x79ca63d1.
//
// Solidity: function createRollup(bytes32 _vmState, uint128 _gracePeriodTicks, uint128 _arbGasSpeedLimitPerTick, uint64 _maxExecutionSteps, uint64 _maxTimeBoundsWidth, uint128 _stakeRequirement, address _stakeToken, address _owner) returns()
func (_ArbFactory *ArbFactoryTransactorSession) CreateRollup(_vmState [32]byte, _gracePeriodTicks *big.Int, _arbGasSpeedLimitPerTick *big.Int, _maxExecutionSteps uint64, _maxTimeBoundsWidth uint64, _stakeRequirement *big.Int, _stakeToken common.Address, _owner common.Address) (*types.Transaction, error) {
	return _ArbFactory.Contract.CreateRollup(&_ArbFactory.TransactOpts, _vmState, _gracePeriodTicks, _arbGasSpeedLimitPerTick, _maxExecutionSteps, _maxTimeBoundsWidth, _stakeRequirement, _stakeToken, _owner)
}
